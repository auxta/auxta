import playwright, {PlaywrightDriver} from "./playwright/playwright";
import {FunctionHelperPlaywright} from "./macros/helpers/code.helper.playwright";
...
class AuxTAPlaywright extends FunctionHelperPlaywright {
    public playwright: PlaywrightDriver = playwright;
    ...
    public async startBrowser(event: any, callback: any, feature: string, scenario: string, overrideConfig?: any, singleFeature = false, fileName = '') {
        ...
        return this.playwright.run(event, callback, feature, scenario)
    }
    ...
    public async startBrowserRPA(event: any, callback: any, baseURL: string, fileName = '') {
        ...
        this.uploadModel.currentSuite = fileName
        return this.playwright.runRPA(event, callback)
    }
...
export const StepStatusPlaywright = StatusOfStep;

const auxtaPlaywright: AuxTAPlaywright = new AuxTAPlaywright();

export default auxtaPlaywright;
